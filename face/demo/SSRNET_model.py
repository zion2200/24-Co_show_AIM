...
from tensorflow.keras.layers import (
    Input, Activation, Dense, Flatten, Dropout, Multiply, Lambda, Conv2D, 
...
class SSR_net_general:
    def __init__(self, image_size, stage_num, lambda_local, lambda_d):
        self._channel_axis = -1  # TensorFlow 기본 값은 'channels_last'
        self._input_shape = (image_size, image_size, 3)
        self.stage_num = stage_num
        self.lambda_local = lambda_local
        self.lambda_d = lambda_d
    ...
    def __call__(self):
        ...
        # Feature extraction block (s)
        s = Conv2D(16, (3, 3), padding="same")(inputs)
        s = BatchNormalization(axis=self._channel_axis)(s)
        s = Activation('tanh')(s)
        s_layer1 = MaxPooling2D((2, 2))(s)
